...
当时面试官说大概一周会出面试结果,其实感觉答得还不错.但是等了几天都没有消息,只能在系统里看到还在面试中。
结果在第二周的时候,hr给我打了电话,约了现场面试。
9.5的高铁从徐州到成都,9.6下午两点现场面,在天府大道那边。二面,hr面,总监面一个下午面完了,做下大概记录,记不太清了。
...
> 聊实习项目,然后我讲了几个遇到的难点
面试官针对这几个难点,依次问了几个问题1.如果上万个,十万个数据,怎么优化,我之前用的分时函数的思想做优化的,这里他说可以把定位和滑动分开来做。分开的话,可以用节流做优化,定位可以根据js对象来计算高度
2.动画优化的表格,如果不用css怎么优化。事件委托,防抖.

> 问了他一些问题

二面其他问题我都记不得了。这一面就是leader面了,负责组里的前端和后端

#### ** hr面 **

hr面是hr和hr助理小姐姐一起面的。然后问了一堆问题,这也是我唯一一次hr被问到了技术的....

> 为什么做前端
为什么不做后端
聊了实习项目,追问了好几个问题,有没有肉鸡,IP要不要过滤之内的,以及项目的产出

> 场景题
如果有10000条数据,后端这边拿到数据的时候是9999条,入库前有缓存,怎么分析
...
最欣赏室友哪点
兴趣爱好
觉得自己性子急不急,是不是拿到一件事情,很想立刻做  
这里差点就被套路了2333 还好我说了是,他说,嗯,标准的重庆人2333
第几次来成都了
问了好多,记不清了

#### ** 总监面 **

总监当时不在公司,有点事,就等总监到公司来。中途和hr助理小姐姐聊了下天,之前的面试什么的也都是她安排的。
...
> 你先写一个二叉排序树查中间节点吧
写了一个,给他看
他说,你理解错我的意思了,是查中间节点,不是查节点 
23333，然后又写了一个

> 聊了下我们工作室,以及我怎么教新同学的,还问了些其他问题

> 然后又让我写了一个算法题,剑指offer原理,勉强写出来了

> 然后聊简历项目
tf-idf算法
你这个idf是什么
idf怎么计算的,讲一下
然后我讲了下idf的计算公式,但是我记不清了,log里面的分母指什么...刚好总监还会,尴尬

> 我说idf的分母是(文章的词频数 + 1)
他说你确定是文章词频吗
我说不确定,好像是语料库里的词频数
他说你这个算法掌握得不好啊,下去自己看看吧  这里就感觉自己要凉了

> 然后继续问项目,这里的余弦相似定理怎么做的
我说把用户的query和数据库的里的问题转成向量算余弦
他说余弦怎么转的
我说通过tf-idf拿出值最高的几十个关键词,以这几十个关键词为基础,生成向量
然后他问这个维度你怎么确定的,怎么确定向量维度
这里我就懵了,这个问题我还从来没有想过.... 尴尬的说了下这个参数我还没调试过,开发的时候,直接调的gensim库训的模型


> 然后问了下最近半年印象深刻比较结束的书,问了几个问题

> 然后说我这里面试就结束了,你和hr聊

但是我已经和hr聊过了,hr过来说今天我们面试就结束了.... 心里以为凉透了

结果走了不到半个小时,hr助理小姐姐给我打电话,说面试通过了,offer在走流程了,半个月到一个月之内发下来

看了下状态,也是拟录取了。** 2333，拿了成都的offer美滋滋。之前春招拿了成都京东的offer没回去,这次应该要回去了。**

成都也有很多小学,初中,高中同学都在那边,离家也近,想回去了。导致那天晚上的阿里笔试,我做了十分钟就关电脑了23333
...
```
*********************************
**<span class="under0"> 寄生组合式继承 </span>**

高效体现在只调用了一次SuperType构造函数
...
#### ** 一面79分钟(9.3) **
看了我博客,评级很高。面试的时候问了几个问题,答得不错,就说基础的就不问我了

>自我介绍

> 讲一个项目吧,讲了实习项目。(讲了很久,说我很健谈23333)
说了项目延期了,然后问了你觉得导致项目延期的原因有哪些
项目的codereview是怎么做的

> 问了我们工作室的情况,以及我在工作室的项目

> 输入一个url,　如果丢包了会怎样,比如服务端第二次没有把数据包发给客户端

> canvans和svg的区别
[经典面试题（讨论canvas与svg的区别）](https://blog.csdn.net/helloword_chen/article/details/49788309)
...
> 沙漏,一个四分钟和一个七分钟的沙漏,如何计时九分钟

> 两个单链表判断是否相交,剑指offer

> 编译原理学得怎样

> 腾讯文档-电子表格,设计列A,B,C....Z,AA...AZ....,面试官提示这可以抽象成一个十进制转二十六进制的问题,后面再想想
...
平时喜欢做哪些运动
然后我问了一些问题
面试官说我看的那本设计模式就是他们组长!!!太强了,曾探大神

其他记不得了,如果通过大概两天之内会安排二面

** 希望能过!!2333 **

#### ** 二面37分钟(9.6) **
面完美团那天傍晚给我打的电话,约了第二天二面,然后我改签了高铁,在成都多待了一天。

凉凉,还是记录下吧。这要还是我分心,又搞前端,后端又搞算法,导致前端的深度差了些。还是有一点点可惜吧,这是我挺喜欢的团队
...
[40行js实现一个简易Promise](https://segmentfault.com/a/1190000013615320)
[从零实现一个简单的 Promise](https://juejin.im/entry/597ddade5188257f98295191)

> 设计模式

> 几十万个dom节点,滚动怎么优化
[百万数据如何在前端快速流畅显示？](http://www.cnblogs.com/hustskyking/p/million-data-show-in-front-end.html)
[Javascript高性能动画与页面渲染](http://www.infoq.com/cn/articles/javascript-high-performance-animation-and-page-rendering)
[前端高性能滚动 scroll 及页面渲染优化](https://my.oschina.net/swmhxhs/blog/748531)
[使输入处理程序去除抖动](https://developers.google.com/web/fundamentals/performance/rendering/debounce-your-input-handlers?hl=zh-cn)
...
[利用享元模式来解决DOM元素过多导致的网页解析慢、卡死的问题](https://blog.csdn.net/ooim802/article/details/54772870)
[页面卡顿性能优化的两个解决方案](https://blog.csdn.net/u014787301/article/details/79362861)

> 白屏怎么分析排查优化
[web前端白屏时间如何优化？](https://www.zhihu.com/question/52598263)
...
> 前端监控,错误搜集(兜底容灾 + 监控预警)
[前端代码异常日志收集与监控](https://www.barretlee.com/blog/2015/08/20/cb-fe-monitor/)

> ssr
[Vue.js 服务器端渲染指南](https://ssr.vuejs.org/zh/)
[Vue 全站服务器渲染 SSR 实践](https://juejin.im/entry/59715c5af265da6c2e0fb67b)

> 缓存

> 机器学习算法,讲了lr,bagging,还有决策树
...
我也是通过这次面试才发现,看了我博客和github的面试官,对我评价都很高.... 尴,我好菜
...
function parallel(taskArr, cb){
  if (!taskArr &&  Array.isArray(taskArr) && !taskArr.length) {
    throw new Error('the taskArr param is not valid');
  }

  if (typeof cb !== 'function') {
    throw new Error('the cb param is not a function')
  }

  let args = [];
  let count= 0;

  let done = function(arg, index) {
...
let timer = null;
taskArr.forEach(function(val, index) {
    val();
  })
}

let a1 = new A(); console.log(a1.value) // 1
let a2 = new A(); console.log(a2.value) // 2
let a3 = new A(); console.log(a3.value) // 3
